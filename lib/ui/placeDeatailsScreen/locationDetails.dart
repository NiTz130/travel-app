...
import '../../ui/createTrip.dart';
import 'placeCoverImage.dart';
import 'placeDescreption.dart';
import '../../ui/tripDetailsPlan.dart';
        ...
        listener: (context, state) {
          ...
          if(state is placeAddToFavoriteState){
            ...
            if(state.isAdd == true){
              ...
              .showSnackBar(const SnackBar(content:Text("Địa điểm được thêm vào mục yêu thích")));
            }
            ...
            if(state.isRemove == true){
              ScaffoldMessenger.of(context)
                .showSnackBar(const SnackBar(content:Text("Đã xóa địa điểm khỏi mục yêu thích")));
            }
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        children: [
                                          ShimmerLoading(
                                            isLoading: isLoading,
                                            child:!isLoading? Text("Thông tin",
                                              style: GoogleFonts.cabin(
                                                            textStyle:const TextStyle(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Row(
                                          children: [
                                            ShimmerLoading(
                                              isLoading: isLoading,
                                              child: !isLoading?Text("Các điểm tham quan ở ${placeDetails.name}",
                                                style: GoogleFonts.cabin(
                                                              textStyle:const TextStyle(
                                                                color: Color.fromARGB(255, 0, 0, 0),
                                                                fontSize: 16,
                                    ...
                                    //list------------------------------------------------------
                                      ...
                                      Visibility(
                                        ...
                                        child: ShimmerLoading(
                                          isLoading: isLoading,
                                          child: placesList(
                                            placeName: !isLoading ? placeDetails.name : 'Chưa xác định',
                                            placeType: 'điểm tham quan', // VIỆT HÓA ở đây
                                          ...
                                          child: Row(
                                            children: [
                                              ShimmerLoading(
                                                ...
                                                child: !isLoading
                                                    ? Text(
                                                  "Chỗ ở & Ăn uống", // Gọn, súc tích, hợp ngữ cảnh du lịch
                                                  style: GoogleFonts.cabin(
                                                    textStyle: const TextStyle(
                                                      color: Color.fromARGB(255, 0, 0, 0),
                                                      fontSize: 16,
                                      ...
                                      Visibility(
                                        ...
                                        child: ShimmerLoading(
                                          isLoading: isLoading,
                                          child: placesList(
                                            placeName: !isLoading ? placeDetails.name : 'nan', // Tên địa điểm (thành phố)
                                            placeType: 'restaurant', // Loại: nhà hàng/quán ăn
                                            navigateBackState: (val) {
                                              if (val == true) {
                                                navigateBack(); // Quay lại màn hình trước khi chọn
                                              }
                                            },
                                          ),
                                        ),
                                        ...
                                        child: Padding(
                                          ...
                                          child: Row(
                                            children: [
                                              GestureDetector(
                                                onTap: () {
                                                  // Có thể thêm xử lý khi người dùng nhấn vào loading card
                                                },
                                                child: Container(
                                                  width: 340,
                                                  height: 150,
                                                  ...
                                                  // Gợi ý: Bạn có thể thêm hiệu ứng loading, ví dụ: Shimmer hoặc CircularProgressIndicator tại đây cho trực quan hơn
                                                  // Hoặc thêm text: "Đang tải dữ liệu..." (nếu muốn cho user biết)
                                                  // child: Center(child: Text("Đang tải dữ liệu...", style: TextStyle(fontSize: 16))),
                                                ),
                                              ),
                                            ],
                                          ),
                                                              ...
                                                              child: CircleAvatar(
                                                                ...
                                                                backgroundImage: NetworkImage(
                                                                  currentReviews.isNotEmpty
                                                                      ? currentReviews[currentReviews.length - 1]["reviewerPhotoUrl"]
                                                                      : placeDetails.reviews[placeDetails.reviews.length - 1]["reviewerPhotoUrl"],
                                                                ),
                                                              ),
                                                            ),
                                                            Column(
                                                              crossAxisAlignment: CrossAxisAlignment.start, // Cho đẹp, căn trái
                                                              children: [
                                                                SizedBox(
                                                                  width: 260,
                                                                  child: Row(
                                                                    children: [
                                                                      Padding(
                                                                        ...
                                                                        child: SizedBox(
                                                                          child: Text(
                                                                            // Tên người đánh giá
                                                                            currentReviews.isNotEmpty
                                                                                ? currentReviews[currentReviews.length - 1]["name"]
                                                                                : placeDetails.reviews[placeDetails.reviews.length - 1]["name"],
                                                                            style: GoogleFonts.cabin(
                                                                              textStyle: const TextStyle(
                                                                                color: Color.fromARGB(255, 0, 0, 0),
                                                                                fontSize: 13,
                                                                      ...
                                                                      Padding(
                                                                        ...
                                                                        child: SizedBox(
                                                                          child: Text(
                                                                            // Thời gian: ví dụ "3 giờ trước"
                                                                            currentReviews.isNotEmpty
                                                                                ? TimeAgoSince.timeAgoSinceDate(currentReviews[currentReviews.length - 1]["publishAt"])
                                                                ...
                                                                // Nhãn tiếng Việt, bạn có thể thêm cho đậm chất Việt (optional)
                                                                // Padding(
                                                                //   padding: const EdgeInsets.only(left: 13, top: 2),
                                                                //   child: Text(
                                                                //     "Nhận xét mới nhất", // hoặc "Bình luận gần đây"
                                                              ...
                                                              SizedBox(
                                                                ...
                                                                child: TextField(
                                                                  ...
                                                                  decoration: InputDecoration(
                                                                    hintText: "Thêm đánh giá đầu tiên cho địa điểm này", // <-- Việt hóa dòng này!
                                                                    filled: true,
                                                ...
                                                child: Column(
                                                  children: [
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: Row(
                                                        children: [
                                                          Text("Chọn phương tiện để đến địa điểm này",
                                                            style: GoogleFonts.cabin(
                                                                  textStyle:const TextStyle(
                                                                    color: Color.fromARGB(255, 112, 112, 112),
                                                                    fontSize: 10,
