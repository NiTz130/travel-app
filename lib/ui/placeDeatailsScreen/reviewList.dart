...
class reviewList extends StatefulWidget {
  ...
  reviewList({
    ...
    required this.mFPAddReview,
    required this.reviewText,
    required this.deleteReviews
  });
                                    ...
                                    children: [
                                                      ...
                                                      children: [
                                                        Row(
                                                          children: [
                                                            ...
                                                            Text(
                                                              TimeAgoSince.timeAgoSinceDate(
                                                                isValidTimestamp(widget.currentReviews[index]["publishAt"])
                                      ...
                                      Visibility(
                                        ...
                                        child: GestureDetector(
                                          onTap: () {
                                            setState(() {
                                              widget.currentReviews.removeWhere(
                                                    (element) => element["reviewId"] == widget.currentReviews[index]["reviewId"],
                                              );
                                            });
