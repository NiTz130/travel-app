...
class _MyFavoriteState extends State<MyFavorite> {
  ...
  Future<void> navigateAndDisplaySelection(BuildContext context, String placeType, String placeId) async {
                    ...
                    return GestureDetector(
                      onTap: () {
                        navigateAndDisplaySelection(
                            context, favListSnapshot[index].placeType, favListSnapshot[index].placeId);
                      },
                      child: Card(
                        color: const Color.fromARGB(255, 253, 250, 250),
                        key: ValueKey(index),
                                    ...
                                    Row(
                                      children: [
                                        SizedBox(
                                          width: 200,
                                          child: Text(
                                            favListSnapshot[index].placeName,
                                            ...
                                            child: Card(
                                              ...
                                              child: FittedBox(
                                                ...
                                                child: Padding(
                                                  padding: const EdgeInsets.all(10.0),
                                                  child: Text(
                                                    favListSnapshot[index].placeType == "locality"
                                                        ? "Thành phố"
                                                        : "Điểm tham quan",
                                                    style: GoogleFonts.cabin(
                                                      textStyle: const TextStyle(
                                  ...
                                  children: [
                                    GestureDetector(
                                      onTap: () {
                                        ...
                                        setState(() {
                                          favListSnapshot.removeWhere(
                                                  (element) => element.placeId == favListSnapshot[index].placeId);
                                        });
                  ...
                  child: Column(
                    children: [
                      Container(
                        ...
                        height: 80,
                        child: Image.network(
                            "https://cdn-icons-png.flaticon.com/128/4715/4715416.png"),
                      ),
                      Text(
