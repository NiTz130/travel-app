...
Flutter travel planning app for Android. The app uses Firebase Auth, Cloud Firestore, Realtime Database, BLoC state management, and external travel data APIs for maps, weather, directions, and destination imagery.

## Features

- Email/password and Google sign-in flows
- Email verification and password reset screens
- Home, search, favorites, profile, and trip navigation
- Trip creation and trip detail planning
